...
- O módulo de ficha financeira solicita o período desejado, os PDFs a serem processados e salva os arquivos `PROVENTOS.csv`, `ADIC. INSALUBRIDADE PAGO.csv` e `CARTÕES.csv` automaticamente na pasta do primeiro arquivo.
